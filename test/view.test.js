...
describe("тест eventListener в контроллере", function() {
  inputLeft = document.querySelector(".input-left1")
  inputRight = document.querySelector(".input-right1")

  it('addEventListener при вызове controller.makeThumbRangeInputHandlerL()', function() {
  ...
  it('addEventListener при вызове controller.makeThumbRangeInputHandlerR()', function() {
  ...
  it('addEventListener при вызове controller.makeTrackZindexMousemoveHandlerL()', function() {
  ...
  it('addEventListener при вызове controller.makeTrackZindexMousemoveHandlerR()', function() {
...
describe("тест .on в контроллере", function() {
  ...
  it('при controller.makeScaleBubbleRangeMultiClickHandler() и клике по шкале View.countMultiPositionLeft = Model.countMultiPositionLeft, View.position = Model.percentLeft, View.countMultiPositionRight = Model.countMultiPositionRight', function() {
