...
// const Сontroller = require('../src/range.227ef839.js')
...
describe("тест добавления eventListener для multirange-slider", function() {
  ...
  test('addEventListener при вызове controller.inTouchLeft()', function() {
  ...
  test('addEventListener при вызове controller.inTouchRight()', function() {
  ...
  test('addEventListener при вызове controller.inMoveLeft()', function() {
    // sinon.spy(inputLeft, 'addEventListener')
  ...
  test('addEventListener при вызове controller.inMoveRight()', function() {
    // sinon.spy(inputRight, 'addEventListener')
  ...
  test('addEventListener при вызове controller.inGetLeft()', function() {
    // sinon.spy(inputLeft, 'addEventListener')
  ...
  test('addEventListener при вызове controller.inGetRight()', function() {
    // sinon.spy(inputRight, 'addEventListener')
